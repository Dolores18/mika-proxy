...
#[derive(Default)]
pub struct RuleSet {
    pub dst_domain_regex: Option<RuleMappedRegexSet>,
    pub dst_domain_full: Option<RuleMappedAhoCorasick>,
    pub dst_domain_sub: Option<RuleMappedAhoCorasick>,
    pub dst_domain_keyword: Option<RuleMappedAhoCorasick>,
    pub dst_geoip: Option<rules::GeoIpSet>,
    pub dst_ipv4_ordered_set: Vec<(Ipv4Cidr, RuleHandle)>,
    pub dst_ipv6_ordered_set: Vec<(Ipv6Cidr, RuleHandle)>,
    pub r#final: Option<RuleHandle>,
    pub first_resolving_rule_id: Option<RuleId>,
}
